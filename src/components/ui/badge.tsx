  ...
  "group/badge inline-flex h-5.5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2.5 py-0.5 text-xs font-semibold whitespace-nowrap transition-all focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
        ...
        // 디자인 시스템의 회색 칩(Healthy) — 개수·상태 표시용 중립 배지
        secondary: "bg-muted text-foreground/70 [a]:hover:bg-muted/80",
        // 빨간 칩(New) — 브랜드 강조
        brand: "bg-accent text-accent-foreground [a]:hover:bg-accent/80",
        // 노란 칩(Popular) — 주의
